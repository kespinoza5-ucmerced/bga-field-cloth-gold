 ...
 * -----
 * 
 * fieldofclothofgold.action.php
 *
 * fieldofclothofgold main action entry point
 *
 *
 ...
 */
  ...
  class action_fieldofclothofgold extends APP_GameAction
  { 
    // Constructor: please do not modify
   	public function __default()
  	{
  	    ...
  	    {
            $this->view = "fieldofclothofgold_fieldofclothofgold";
